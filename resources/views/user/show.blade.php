              ...
              <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <div class="mb-4 text-center">
                    @if($product->shop->filename !== null)
                      <img class="mx-auto object-cover w-40 h-40 rounded-full" src="{{ asset("storage/shops/{$product->shop->filename}")}}">
                    @else
                      <img src="">
                    @endif
                  </div>
                  <div class="mb-4 text-center">
                    <button data-micromodal-trigger="modal-1" type="button" class="text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                  </div>
              </div>
          </div>
      </div>
